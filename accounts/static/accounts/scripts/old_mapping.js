      ...
      ,fullscreenControl: true,
       fullscreenControlOptions: {
           ...
           'opacity': 1
              ...
              //TZ
              $.getJSON('../tanzania', function(data){
                      ...
                      $("#selectregion").append("<option value=\'"+feature.properties.regionid+"\'>"+ feature.properties.region_nam +"</ option>");  
                       layer.on('mouseover', function (e) {
                           ...
                           layer.on('mouseout', function (e) {
                                this.setStyle({
                                 opacity: 0.4,fillOpacity:0.4// back to original
                                 });
      ...
      "<th scope=\"col\">Details</th>   </tr> </thead> <tbody>";
            ...
            hideLayers(geojson);
                                         ...
                                         var const_id=layer.feature.properties.constid;
                                          ...
                                          map.fitBounds(e.target.getBounds());
                                         $("#regname").text("Clicked: "+region+" > "+constituency);
                     ...
                     selections.length=0;
                        ...
                        var convotes=[];
                         ...
                         $.getJSON( "../get_Const_Winners/?const="+const_id, function( data ) {

wintable+="<tr><th scope=\"row\">Name</th> <td>"+ data[0].fields.candidate+"</td>"
      
    +"</tr> <tr><th scope=\"row\">Votes</th>   <td>"+data[0].fields.votes+"</td>  </tr>"
    +"<tr> <th scope=\"row\">Photo</th> <td><img src=\"../../static/home/images/"+(1)+".jpeg\"  alt=\"Avatar\"r\"/><td>  </tr>"
 +" <tr> <th scope=\"row\">Party</th> <td>"+chamas[parseInt(data[0].fields.chama_id)-1] +"</td> </tr>"


 let st= "vertical-align: middle;  width: 40px;  height: 40px;  border-radius: 50%;";
           ...
           fillOpacity:0.4 }; 
                 ...
                 // populate wards select
                   $("#selectwards").append("<option value=\'"+feature.properties.wardid+"\'>"+ feature.properties.ward_name +"</ option>");
                        ...
                        layer.bindPopup("<p>"+feature.properties.ward_name +"<br>"+feature.properties.const
                                    +"<br>"+feature.properties.district_n+"<br>"+feature.properties.pk+"</p>");
       ...
       $.getJSON( "../get_C_wards_Winners/?ward="+ward_id, function( data ) {
                                let st= "vertical-align: middle;  width: 40px;  height: 40px;  border-radius: 50%;";
                                let divcont2="<table class=\"table\"> <thead><tr> <th scope=\"col\">#</th>"+
                "<th scope=\"col\">Symbol</th><th scope=\"col\">Photo</th><th scope=\"col\">Name</th><th scope=\"col\">Votes</th>"+
            "</tr> </thead><tbody>";
$("#resultsdiv").html(' ');
              for(var i = 0; i < data.length; i++) {
