...
$("#selectconstituent").append("<option value=\'"+feature.properties.constid+"\'>"+ feature.properties.const +"</ option>");
              ...
              var divcont1="<table class=\"table\"> <thead><tr> <th scope=\"col\">#</th>"+
        ...
        map.on('click', function (e) {
            ...
            this.setStyle({
              ...
              //add pop up
            var wintable="<table class=\"table\">  <thead>   <tr>"
...
//     +"<tr> <th scope=\"row\">Photo</th> <td><img src=\"../../static/home/images/"+(1)+".png\"  alt=\"Avatar\"style=\""+st+"\" class=\"avatar\"></td>  </tr>"
