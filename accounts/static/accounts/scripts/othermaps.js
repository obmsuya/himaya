...
let url = "http://10.10.6.107:8081/geoserver/bongo/wms";
    let constlayer = L.tileLayer.wms(url, {
        layers: 'bongo:MikoaJimbo'

    });


    let constlayer2 = L.tileLayer.wms(url, {
        layers: 'bongo:Main_Roads'
    ...
    $.getJSON("../tanzania", function (data) {
        var geojson = L.geoJson(data, {
            style: { color: "#FFFFFF", weight: 5, fillOpacity: 0.1, opacity: 0.5 },
        ...
        var geojson = L.geoJson(data, {
            onEachFeature: function (feature, layer) {
                ...
                layer.on("mouseover", function (e) {
                    ...
                    layer.bindPopup("<h6>" + feature.properties.region_nam + "<br>" + "Voters:" + feature.properties.votes + "</h6>");
                    this.openPopup();
                });
